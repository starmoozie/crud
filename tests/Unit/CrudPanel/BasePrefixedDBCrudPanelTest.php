...
abstract class BasePrefixedDBCrudPanelTest extends BaseCrudPanelTest
{
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('db:seed', ['--class' => 'Starmoozie\CRUD\Tests\Config\Database\Seeds\UsersRolesTableSeeder']);
        $this->artisan('db:seed', ['--class' => 'Starmoozie\CRUD\Tests\Config\Database\Seeds\UsersTableSeeder']);
        $this->artisan('db:seed', ['--class' => 'Starmoozie\CRUD\Tests\Config\Database\Seeds\ArticlesTableSeeder']);
    }
