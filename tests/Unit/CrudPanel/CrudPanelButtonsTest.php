...
class CrudPanelButtonsTest extends BaseCrudPanelTest
{
    ...
    {
        $this->markTestIncomplete('This no longer makes sense in Starmoozie 4.1. Button names are unique now.');
    ...
    public function testAddButtonFromView()
    {
        ...
        $starmoozieButtonViewPackage = 'crud::buttons.';
        ...
        $this->assertEquals($starmoozieButtonViewPackage.$viewName, $actualButton->content);
        $this->assertEquals($expectedButton->stack, $actualButton->stack);
    }
