...
class CrudPanelViewsTest extends BaseCrudPanelTest
{
    ...
    {
        Config::set('starmoozie.crud.operations.create.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('starmoozie.crud.operations.create.contentClass'), $this->crudPanel->getCreateContentClass());
    }
    ...
    {
        Config::set('starmoozie.crud.operations.update.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('starmoozie.crud.operations.update.contentClass'), $this->crudPanel->getEditContentClass());
    }
    ...
    public function testGetUpdateContentClassFromConfig()
    {
        ...
        $this->assertEquals(Config::get('starmoozie.crud.operations.update.contentClass'), $this->crudPanel->getUpdateContentClass());
    }
    ...
    {
        Config::set('starmoozie.crud.operations.show.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('starmoozie.crud.operations.show.contentClass'), $this->crudPanel->getShowContentClass());
    }
    ...
    {
        Config::set('starmoozie.crud.operations.list.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('starmoozie.crud.operations.list.contentClass'), $this->crudPanel->getListContentClass());
    }
    ...
    {
        Config::set('starmoozie.crud.operations.reorder.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('starmoozie.crud.operations.reorder.contentClass'), $this->crudPanel->getReorderContentClass());
    }
}
