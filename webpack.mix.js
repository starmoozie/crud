...
/*
 ...
 |--------------------------------------------------------------------------
 |
 | Starmoozie maintainers use mix to:
...
mix.js('src/resources/assets/js/bundle.js', 'src/public/packages/starmoozie/base/js/');

// merge all needed CSS into a big bundle file
mix.sass('src/resources/assets/scss/bundle.scss', 'src/public/packages/starmoozie/base/css/')
	.options({
