...
trait LicenseCheck
{
    ...
    private function checkLicenseCodeExists()
    {
        ...
        if (! $this->validCode(config('starmoozie.base.license_code'))) {
            \Alert::add('warning', "<strong>You're using unlicensed software.</strong> Please ask your web developer to <a target='_blank' class='alert-link text-white' href='http://starmoozieforlaravel.com'>purchase a license code</a> to hide this message.");
        }
    }
