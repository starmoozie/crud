...
trait Stats
{
    ...
    /**
     * Send usage statistics to the StarmoozieForLaravel.com website.
    ...
    private function sendUsageStats()
    {
        ...
        $url = 'https://starmoozieforlaravel.com/api/stats';
        $method = 'PUT';
        $stats = [
            'URL'                   => url('') ?? false,
            ...
            'BACKPACK_CRUD_VERSION' => \PackageVersions\Versions::getVersion('starmoozie/crud') ?? false,
            'BACKPACK_LICENSE'      => config('starmoozie.base.license_code') ?? false,
            'BACKPACK_URL'          => starmoozie_url('') ?? false,
        ];
