...
namespace Starmoozie\CRUD\app\Http\Controllers\Operations;
...
trait ShowOperation
{
    ...
    protected function setupShowDefaults()
    {
        ...
        $this->crud->operation(['create', 'update'], function () {
            $this->crud->addSaveAction([
                ...
                'button_text' => trans('starmoozie::crud.save_action_save_and_preview'),
            ]);
        });
    }
    ...
    public function show($id)
    {
        ...
        $this->data['title'] = $this->crud->getTitle() ?? trans('starmoozie::crud.preview').' '.$this->crud->entity_name;
