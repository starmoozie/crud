...
namespace Starmoozie\CRUD\app\Library\CrudPanel;

use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Access;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\AutoFocus;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\AutoSet;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Buttons;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Columns;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Create;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Delete;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Errors;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\FakeColumns;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\FakeFields;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Fields;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Filters;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\HeadingsAndTitles;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Macroable;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Operations;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Query;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Read;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Relationships;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Reorder;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\SaveActions;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Search;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Settings;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Tabs;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Update;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Validation;
use Starmoozie\CRUD\app\Library\CrudPanel\Traits\Views;
use Exception;
...
class CrudPanel
{
     ...
     *
     * DEPRECATION NOTICE: This method is no longer used and will be removed in future versions of Starmoozie
     *
     * @deprecated
     * @return bool
     */
     ...
     * - $this->crud->setRoute(config('starmoozie.base.route_prefix').'/article')
     * - $this->crud->setRouteName(config('starmoozie.base.route_prefix').'.article')
     * - $this->crud->route = config('starmoozie.base.route_prefix')."/article"
     *
     * @return string
     */
