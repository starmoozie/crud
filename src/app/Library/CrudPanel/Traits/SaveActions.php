...
trait SaveActions
{
    ...
    {
        return config('starmoozie.crud.operations.'.$this->getCurrentOperation().'.defaultSaveAction', 'save_and_back');
    }
    ...
    public function getFallBackSaveAction()
    {
        ...
        //if there is an higher action and that action is not the starmoozie default higher one `save_and_back` we return it.
    ...
    public function setSaveAction($forceSaveAction = null)
    {
        ...
        if (
            ...
            \Alert::info(trans('starmoozie::crud.save_action_changed_notification'))->flash();
        }
    ...
    /**
     * This functions register Starmoozie default save actions into CRUD.
     *
     * @return array
     */
    public function setupDefaultSaveActions()
    {
        $defaultSaveActions = [
            ...
            [
                ...
                'button_text' => trans('starmoozie::crud.save_action_save_and_edit'),
            ],
            [
                'name' => 'save_and_new',
                'visible' => function ($crud) {
                ...
                'button_text' => trans('starmoozie::crud.save_action_save_and_new'),
            ],
        ];
