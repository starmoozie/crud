...
trait Settings
{
    ...
    public function getOperationSetting(string $key, $operation = null)
    {
        ...
        return $this->get($operation.'.'.$key) ?? config('starmoozie.crud.operations.'.$this->getCurrentOperation().'.'.$key) ?? null;
    }
    ...
    /**
     * Automatically set values in config file (config/starmoozie/crud)
