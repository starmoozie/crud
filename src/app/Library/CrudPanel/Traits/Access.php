...
trait Access
{
     ...
     * @param string $operation
     *
     * @throws \Starmoozie\CRUD\Exception\AccessDeniedException in case the operation is not enabled
     *
     * @return bool
     */
    ...
    {
        if (! $this->get($operation.'.access')) {
            throw new AccessDeniedException(trans('starmoozie::crud.unauthorized_access', ['access' => $operation]));
        }
