...
trait Search
{
    ...
    */
    ...
    public function getResponsiveTable()
    {
        ...
        return config('starmoozie.crud.operations.list.responsiveTable');
    }
    ...
    public function getPersistentTable()
    {
        ...
        return config('starmoozie.crud.operations.list.persistentTable');
    }
    ...
    public function getPersistentTableDuration()
    {
        ...
        return config('starmoozie.crud.operations.list.persistentTableDuration', false);
    }
