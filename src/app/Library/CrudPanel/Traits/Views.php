...
trait Views
{
    ...
    {
        return $this->get('create.contentClass') ?? config('starmoozie.crud.operations.create.contentClass', 'col-md-8 bold-labels');
    }
    ...
    {
        return $this->get('list.contentClass') ?? config('starmoozie.crud.operations.list.contentClass', 'col-md-12');
    }
    ...
    {
        return $this->get('show.contentClass') ?? config('starmoozie.crud.operations.show.contentClass', 'col-md-8 col-md-offset-2');
    }
    ...
    {
        return $this->get('update.contentClass') ?? config('starmoozie.crud.operations.update.contentClass', 'col-md-8 bold-labels');
    }
    ...
    {
        return $this->get('reorder.contentClass') ?? config('starmoozie.crud.operations.reorder.contentClass', 'col-md-8 col-md-offset-2');
    }
