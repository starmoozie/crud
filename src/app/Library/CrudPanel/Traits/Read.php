...
trait Read
{
    ...
    {
        return $this->getOperationSetting('defaultPageLength') ?? config('starmoozie.crud.operations.list.defaultPageLength') ?? 25;
    }
     ...
     *
     * https://starmoozieforlaravel.com/docs/4.1/crud-cheat-sheet#page-length
     */
