...
use Starmoozie\CRUD\app\Library\CrudPanel\CrudField;
...
trait Fields
{
     ...
     * Everything else Starmoozie can probably guess. This method makes sure  the
     ...
     * (once by Starmoozie in front-end, once by Laravel Attribute Casting).
     */
