...
use Starmoozie\CRUD\app\Library\CrudPanel\CrudColumn;
...
trait Columns
{
    ...
    /**
     * Move this column to be last in the columns list.
     *
     * @return bool|null
     */
    public function makeLastColumn()
    {
        if (! $this->columns()) {
            return false;
        }

        $lastColumn = array_keys(array_slice($this->columns(), -2, 1))[0];
        $this->afterColumn($lastColumn);
    }
     ...
     * Everything else, Starmoozie can probably guess.
     *
