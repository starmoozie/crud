...
class AddSidebarContent extends Command
{
     ...
     * @var string
     */
    protected $signature = 'starmoozie:add-sidebar-content
     ...
     * @var string
     */
    protected $description = 'Add HTML/PHP code to the Starmoozie sidebar_content file';
    ...
    {
        $path = 'resources/views/vendor/starmoozie/base/inc/sidebar_content.blade.php';
        $disk_name = config('starmoozie.base.root_disk_name');
        ...
        if ($disk->exists($path)) {
            ...
            $this->error('The sidebar_content file does not exist. Make sure Starmoozie is properly installed.');
        }
    }
