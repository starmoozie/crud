...
class PublishStarmoozieMiddleware extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'starmoozie:publish-middleware';
    ...
    /**
     * Build the class. Replace Starmoozie namespace with App one.
     *
     * @param string $name
     *
     * @return string
    ...
    {
        $stub = str_replace('Starmoozie\CRUD\app\\', $this->laravel->getNamespace(), $stub);
