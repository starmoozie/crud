...
class AddCustomRouteContent extends Command
{
     ...
     * @var string
     */
    protected $signature = 'starmoozie:add-custom-route
     ...
     * @var string
     */
    protected $description = 'Add HTML/PHP code to the routes/starmoozie/custom.php file';
    ...
    {
        $path = 'routes/starmoozie/custom.php';
        ...
        if ($disk->exists($path)) {
            ...
            $command = 'php artisan vendor:publish --provider="Starmoozie\Base\BaseServiceProvider" --tag=custom_routes';
