...
class PublishView extends Command
{
     ...
     * @var string
     */
    protected $name = 'starmoozie:publish';
     ...
     * @var string
     */
    protected $signature = 'starmoozie:publish
     ...
     * @var string
     */
    protected $description = 'Publishes a Starmoozie view so you can make changes to it, for your project.';
     ...
     * @var string
     */
    public $sourcePath = 'vendor/starmoozie/crud/src/resources/views/';
     ...
     * @var string
     */
    public $destinationPath = 'resources/views/vendor/starmoozie/';
