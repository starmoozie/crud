...
@php
    ...
    $exportCheckedText = data_get($column, 'labels.checked', trans('starmoozie::crud.yes'));
    $exportUncheckedText = data_get($column, 'labels.unchecked', trans('starmoozie::crud.no'));
