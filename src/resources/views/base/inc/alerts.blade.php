...
<script type="text/javascript">
    ...
    document.onreadystatechange = function () {
        if (document.readyState == "interactive") {
            ...
            var $alerts_from_localstorage = JSON.parse(localStorage.getItem('starmoozie_alerts'))
            ...
            // in the end, remove starmoozie alerts from localStorage
            localStorage.removeItem('starmoozie_alerts');
        }
    };
</script>
